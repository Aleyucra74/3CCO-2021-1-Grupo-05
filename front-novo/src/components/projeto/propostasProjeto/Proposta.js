...
export default function Proposta({ proposta }) {
  ...
  const handleCadastro = e => {
    ...
    console.log(proposta.demandas.idDemanda)
  }
  ...
  return (
    <>
      ...
      <div className="flex flex-row border-all max-w-screen-sm mr-8">
        ...
        {proposta.match > 75 ? <div className="color-green-proposta px-2 rounded-l-lg">
          <p className="text-white pt-10">
            <span className="font-semibold text-large">{proposta.match}%</span>
            <br />
            compatibilidade
          </p>
        </div> : proposta.match > 50 ? <div className="color-yellow-proposta px-2 rounded-l-lg">
          <p className="text-white pt-10">
            <span className="font-semibold text-large">{proposta.match}%</span>
            <br />
            compatibilidade
        ...
        <div className="p-6">
          ...
          <div className="w-80">
            ...
            <div className="flex justify-center">
              <Bar
                data={dataSoftskills(softskillsUsuario)}
                height={3}
                width={3}
                options={options}
              />
